      ...
      <div className="neu-card bg-white max-w-md w-full p-6 space-y-6">
        <div className="text-center">
          ...
          <h3 className="text-xl font-semibold text-gray-900 mb-2">
            {success ? 'Dienstplan erstellt!' : 'Dienstplan mit Warnungen erstellt'}
          </h3>
          
          <p className="text-gray-600 mb-4">
            {success 
              ? 'Der Dienstplan wurde erfolgreich erstellt und ist jetzt verfügbar.' 
              : `Der Dienstplan wurde mit ${violations} Regelverstößen erstellt.`
            }
          </p>
